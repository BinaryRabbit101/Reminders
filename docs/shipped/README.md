...
| [scriptable-widget.md](scriptable-widget.md) | Per-user token feed + `reminders.js` iOS widget | ✅ 2026-08-03, amended 2026-09-02 | Constant-time token scan; widget CONFIG needs port+token after deployment. Token column renamed `widget_token` → `phone_token` (2026-09-02) and now authenticates the Shortcut too. |
