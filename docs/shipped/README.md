...
| [recurrence.md](recurrence.md) | Repeating reminders, DST-safe local-time math | ✅ 2026-08-03 | Advance hangs off the claim; `advanceOrComplete()` is the seam for the complete endpoint. |
